...
The Windows firewall rules the installer adds admit that range next to the
local subnet, which extends the read-only metadata exposure described under
trust boundaries to the machines on your tailnet.
